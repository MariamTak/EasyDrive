...
const Detailsvoiture = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View><Text style={styles.title}>Ajoutez plus de détails{"\n"}</Text></View>
      ...
      <View style={styles.pickerContainer}>
        <Text style={styles.pickerLabel}>Boite de vitesse</Text>
      </View>
      <View style={styles.pickerContainer}>
      <TouchableOpacity onPress={() => setBoite('Manuelle')} style={styles.boiteContainer}>
        ...
        <Text style={styles.picker2Label}>Boite manuelle</Text>
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.pickerContainer}>
       <TouchableOpacity onPress={() => setBoite('Automatique')} style={styles.boiteContainer}>
          <Icon2
            ...
            style={styles.icon}
          />
        <Text style={styles.picker2Label}>Boite automatique</Text>
      ...
      <View style={styles.infoBox}>
        <Text style={styles.infoText}>Ces information aideront les locataires à faire le meilleur choix</Text>
      </View>
